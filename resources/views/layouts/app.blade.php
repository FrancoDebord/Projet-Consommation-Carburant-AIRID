        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="{{ route('carburants.index') }}">Gestion des carburants</a></li>
...
<script src="{{ asset("storage/assets/js/javascript_conso.js") }}"></script>
    @stack('scripts')
</body>
